"""PCVRHyFormer inference script for the baseline_time_period_time_dropout variant.
...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_time_dropout.dataset import (
        FeatureSchema,
        NUM_TIME_BUCKETS,
        PCVRParquetDataset,
    )
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_time_dropout.model import (
        ModelInput,
        PCVRHyFormer,
    )
