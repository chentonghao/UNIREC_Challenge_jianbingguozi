...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_time_dropout.utils import set_seed, EarlyStopping, create_logger
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_time_dropout.dataset import FeatureSchema, get_pcvr_data, NUM_TIME_BUCKETS
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_time_dropout.model import PCVRHyFormer
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_time_dropout.trainer import PCVRHyFormerRankingTrainer
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--time_feat_dropout', type=float, default=0.0,
                        help='Dropout applied only to time/hour/dow embeddings before fusion')
...
def main() -> None:
    ...
    model_args = {
        ...
        "time_feat_dropout": args.time_feat_dropout,
