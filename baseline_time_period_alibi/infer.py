"""PCVRHyFormer inference script for the baseline_time_period_alibi variant.
...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_alibi.dataset import (
        FeatureSchema,
        NUM_TIME_BUCKETS,
        PCVRParquetDataset,
    )
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_alibi.model import (
        ModelInput,
        PCVRHyFormer,
    )
