...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_alibi.utils import set_seed, EarlyStopping, create_logger
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_alibi.dataset import FeatureSchema, get_pcvr_data, NUM_TIME_BUCKETS
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_alibi.model import PCVRHyFormer
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_alibi.trainer import PCVRHyFormerRankingTrainer
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--pos_bias_type', type=str, default='rope',
                        choices=['rope', 'alibi', 'none'],
                        help='Relative position bias type for attention')
