...
class PCVRHyFormer(nn.Module):
    ...
    def __init__(
        ...
        period_recent_bucket_max: int = 0,
        ...
        self.period_recent_bucket_max = period_recent_bucket_max
    ...
    def _embed_seq_domain(
        ...
        if self.use_time_period_features and hour_bucket_ids is not None:
            ...
            if self.period_recent_bucket_max > 0:
                recent_mask = (
                    (time_bucket_ids > 0)
                    & (time_bucket_ids <= self.period_recent_bucket_max)
                ).unsqueeze(-1).to(hour_emb.dtype)
                hour_emb = hour_emb * recent_mask
        ...
        if self.use_time_period_features and dow_bucket_ids is not None:
            ...
            if self.period_recent_bucket_max > 0:
                recent_mask = (
                    (time_bucket_ids > 0)
                    & (time_bucket_ids <= self.period_recent_bucket_max)
                ).unsqueeze(-1).to(dow_emb.dtype)
                dow_emb = dow_emb * recent_mask
