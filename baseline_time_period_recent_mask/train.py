...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_recent_mask.utils import set_seed, EarlyStopping, create_logger
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_recent_mask.dataset import FeatureSchema, get_pcvr_data, NUM_TIME_BUCKETS
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_recent_mask.model import PCVRHyFormer
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_recent_mask.trainer import PCVRHyFormerRankingTrainer
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--period_recent_bucket_max', type=int, default=0,
                        help='Only apply sequence hour/dow period embeddings to '
                             'positions with 0 < time_bucket <= this value '
                             '(0 = disabled)')
...
def main() -> None:
    ...
    model_args = {
        ...
        "use_time_period_features": args.use_time_period_features,
        "period_recent_bucket_max": args.period_recent_bucket_max,
