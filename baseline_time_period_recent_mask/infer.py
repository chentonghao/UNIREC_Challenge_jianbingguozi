"""PCVRHyFormer inference script for the baseline_time_period_recent_mask variant.
...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_recent_mask.dataset import (
        FeatureSchema,
        NUM_TIME_BUCKETS,
        PCVRParquetDataset,
    )
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_recent_mask.model import (
        ModelInput,
        PCVRHyFormer,
    )
