"""PCVRHyFormer inference script for the baseline_time_period_gated variant.
...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_gated.dataset import (
        FeatureSchema,
        NUM_TIME_BUCKETS,
        PCVRParquetDataset,
    )
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_gated.model import (
        ModelInput,
        PCVRHyFormer,
    )
