"""PCVRHyFormer inference script for the baseline_time_period_decay_scaling variant.
...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_decay_scaling.dataset import (
        FeatureSchema,
        NUM_TIME_BUCKETS,
        PCVRParquetDataset,
    )
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_decay_scaling.model import (
        ModelInput,
        PCVRHyFormer,
    )
