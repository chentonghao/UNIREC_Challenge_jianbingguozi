...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_continuous_seq.utils import set_seed, EarlyStopping, create_logger
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_continuous_seq.dataset import FeatureSchema, get_pcvr_data, NUM_TIME_BUCKETS
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_continuous_seq.model import PCVRHyFormer
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_continuous_seq.trainer import PCVRHyFormerRankingTrainer
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--seq_period_encoding', type=str, default='bucket',
                        choices=['bucket', 'continuous'],
                        help='Sequence period encoding: discrete hour/dow buckets or continuous sin/cos features')
...
def main() -> None:
    ...
    train_loader, valid_loader, pcvr_dataset = get_pcvr_data(
        ...
        seq_period_encoding=args.seq_period_encoding,
    )
