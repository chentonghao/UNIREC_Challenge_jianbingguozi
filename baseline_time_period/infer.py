"""PCVRHyFormer inference script for the baseline_time_period variant.
...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period.dataset import (
        FeatureSchema,
        NUM_TIME_BUCKETS,
        PCVRParquetDataset,
    )
    from UNIREC_Challenge_jianbingguozi.baseline_time_period.model import (
        ModelInput,
        PCVRHyFormer,
    )
