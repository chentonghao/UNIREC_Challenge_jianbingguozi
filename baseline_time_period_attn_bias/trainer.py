...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_attn_bias.utils import sigmoid_focal_loss, EarlyStopping
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_attn_bias.model import ModelInput
