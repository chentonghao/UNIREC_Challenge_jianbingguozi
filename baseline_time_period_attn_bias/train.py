...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_attn_bias.utils import set_seed, EarlyStopping, create_logger
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_attn_bias.dataset import FeatureSchema, get_pcvr_data, NUM_TIME_BUCKETS
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_attn_bias.model import PCVRHyFormer
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_attn_bias.trainer import PCVRHyFormerRankingTrainer
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_time_attn_bias', action='store_true', default=False,
                        help='Add learned per-head attention bias from seq time buckets')
...
def main() -> None:
    ...
    model_args = {
        ...
        "use_time_period_features": args.use_time_period_features,
        "use_time_attn_bias": args.use_time_attn_bias,
