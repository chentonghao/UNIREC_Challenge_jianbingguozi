"""PCVRHyFormer inference script for the baseline_time_period_prefix_token variant.
...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_prefix_token.dataset import (
        FeatureSchema,
        NUM_TIME_BUCKETS,
        PCVRParquetDataset,
    )
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_prefix_token.model import (
        ModelInput,
        PCVRHyFormer,
    )
