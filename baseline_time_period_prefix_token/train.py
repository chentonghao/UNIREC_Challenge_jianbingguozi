...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_prefix_token.utils import set_seed, EarlyStopping, create_logger
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_prefix_token.dataset import FeatureSchema, get_pcvr_data, NUM_TIME_BUCKETS
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_prefix_token.model import PCVRHyFormer
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_prefix_token.trainer import PCVRHyFormerRankingTrainer
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_time_prefix_token', action='store_true', default=False,
                        help='Project request-level 4-d time features as a separate NS token')
...
def main() -> None:
    ...
    model_args = {
        ...
        "use_time_period_features": args.use_time_period_features,
        "time_period_mode": args.time_period_mode,
        "use_time_prefix_token": args.use_time_prefix_token,
