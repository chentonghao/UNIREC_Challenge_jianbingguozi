...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_history_time_dropout.utils import set_seed, EarlyStopping, create_logger
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_history_time_dropout.dataset import FeatureSchema, get_pcvr_data, NUM_TIME_BUCKETS
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_history_time_dropout.model import PCVRHyFormer
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_history_time_dropout.trainer import PCVRHyFormerRankingTrainer
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--history_time_dropout', type=float, default=0.0,
                        help='Dropout applied only to sequence time/hour/dow embeddings')
...
def main() -> None:
    ...
    model_args = {
        ...
        "use_time_period_features": args.use_time_period_features,
        "history_time_dropout": args.history_time_dropout,
