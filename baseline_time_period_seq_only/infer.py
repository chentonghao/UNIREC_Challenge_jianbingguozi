"""PCVRHyFormer inference script for the baseline_time_period_seq_only variant.
...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_seq_only.dataset import (
        FeatureSchema,
        NUM_TIME_BUCKETS,
        PCVRParquetDataset,
    )
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_seq_only.model import (
        ModelInput,
        PCVRHyFormer,
    )
