...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_personalized_gate.utils import set_seed, EarlyStopping, create_logger
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_personalized_gate.dataset import FeatureSchema, get_pcvr_data, NUM_TIME_BUCKETS
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_personalized_gate.model import PCVRHyFormer
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_personalized_gate.trainer import PCVRHyFormerRankingTrainer
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--time_fusion_mode', type=str, default='add',
                        choices=['add', 'gated_add'],
                        help='How to fuse sequence time embeddings into token embeddings')
    parser.add_argument('--time_gate_init_bias', type=float, default=-2.0,
                        help='Initial bias for time gates when time_fusion_mode=gated_add')
    parser.add_argument('--use_personalized_time_gate', action='store_true', default=False,
                        help='Let time gates depend on user-side NS context as well as sequence tokens')
...
def main() -> None:
    ...
    model_args = {
        ...
        "use_time_period_features": args.use_time_period_features,
        "time_fusion_mode": args.time_fusion_mode,
        "time_gate_init_bias": args.time_gate_init_bias,
        "use_personalized_time_gate": args.use_personalized_time_gate,
