"""PCVRHyFormer inference script for the baseline_time_period_personalized_gate variant.
...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_personalized_gate.dataset import (
        FeatureSchema,
        NUM_TIME_BUCKETS,
        PCVRParquetDataset,
    )
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_personalized_gate.model import (
        ModelInput,
        PCVRHyFormer,
    )
...
_FALLBACK_MODEL_CFG = {
    ...
    'use_personalized_time_gate': False,
