...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_user_time_dropout.utils import set_seed, EarlyStopping, create_logger
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_user_time_dropout.dataset import FeatureSchema, get_pcvr_data, NUM_TIME_BUCKETS
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_user_time_dropout.model import PCVRHyFormer
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_user_time_dropout.trainer import PCVRHyFormerRankingTrainer
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--user_time_dense_dropout', type=float, default=0.0,
                        help='Dropout applied only to the request-level 4-d time dense suffix')
...
def main() -> None:
    ...
    model_args = {
        ...
        "use_time_period_features": args.use_time_period_features,
        "time_period_mode": args.time_period_mode,
        "user_time_dense_dropout": args.user_time_dense_dropout,
