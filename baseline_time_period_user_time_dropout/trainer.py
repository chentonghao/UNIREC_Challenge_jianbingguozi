...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_user_time_dropout.utils import sigmoid_focal_loss, EarlyStopping
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_user_time_dropout.model import ModelInput
