...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_weekend.utils import set_seed, EarlyStopping, create_logger
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_weekend.dataset import FeatureSchema, get_pcvr_data, NUM_TIME_BUCKETS
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_weekend.model import PCVRHyFormer
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_weekend.trainer import PCVRHyFormerRankingTrainer
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_weekend_feature', action='store_true', default=False,
                        help='Append request-level is_weekend dense feature')
    parser.add_argument('--use_hour_x_weekend_bucket', action='store_true', default=False,
                        help='Use sequence hour-by-weekend bucket embedding')
...
def main() -> None:
    ...
    train_loader, valid_loader, pcvr_dataset = get_pcvr_data(
        ...
        use_weekend_feature=args.use_weekend_feature,
        use_hour_x_weekend_bucket=args.use_hour_x_weekend_bucket,
    )
