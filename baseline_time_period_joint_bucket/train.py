...
try:
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_joint_bucket.utils import set_seed, EarlyStopping, create_logger
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_joint_bucket.dataset import FeatureSchema, get_pcvr_data, NUM_TIME_BUCKETS
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_joint_bucket.model import PCVRHyFormer
    from UNIREC_Challenge_jianbingguozi.baseline_time_period_joint_bucket.trainer import PCVRHyFormerRankingTrainer
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_hour_dow_joint_bucket', action='store_true', default=False,
                        help='Use a joint hour-by-day-of-week sequence bucket instead of separate hour/dow buckets')
...
def main() -> None:
    ...
    train_loader, valid_loader, pcvr_dataset = get_pcvr_data(
        ...
        use_hour_dow_joint_bucket=args.use_hour_dow_joint_bucket,
    )
